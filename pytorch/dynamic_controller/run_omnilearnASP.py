...
from pytorch.dynamic_controller.asp_omnilearn import ASPOmniLearnPS, ASPOmniLearnWorker
...
if __name__ == "__main__":
    ...
    parser.add_argument('--dir', type=str, default='/logs', help='dir where data is saved')
